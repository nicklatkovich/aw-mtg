...
export const _2025_modern: Tournament[] = [
  {
    ...
    name: 'Fall League 2025 | Modern #6/6',
    date: '2025-12-28',
    standings: [
      { player: '4onoki', rank: 1, points: 12, mp: 4, mw: 4, match_record: '4-0-0', game_record: '8-2-0' },
      ...
      { player: 'aspelled', rank: 4, points: 9, mp: 4, mw: 3, match_record: '3-1-0', game_record: '7-3-0' },
      { player: 'ispinyouround', rank: 5, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '5-4-0' },
      { player: 'Spellstutter', rank: 6, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '4-4-0' },
      { player: 'Tanti', rank: 7, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '4-4-0' },
      { player: 'BRV', rank: 8, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '5-5-0' },
      { player: 'Aleksandr_KoLoshk', rank: 9, points: 3, mp: 3, mw: 1, match_record: '1-2-0', game_record: '2-5-0' },
      { player: 'diuzhev', rank: 10, points: 3, mp: 4, mw: 1, match_record: '1-3-0', game_record: '2-7-0' },
      { player: 'Norbi', rank: 11, points: 0, mp: 3, mw: 0, match_record: '0-3-0', game_record: '2-6-0' },
      { player: 'PolR', rank: 12, points: 0, mp: 4, mw: 0, match_record: '0-4-0', game_record: '2-8-0' },
    ],
    rounds: [
      [
        ...
        { players: ['Norbi', 'qvertion'], winner: 2, record: '2-1-0' },
      ],
      [
        { players: ['Azurenia', 'qvertion'], winner: 1, record: '2-1-0' },
        { players: ['4onoki', 'Aleksandr_KoLoshk'], winner: 1, record: '2-0-0' },
        { players: ['diuzhev', 'ispinyouround'], winner: 2, record: '2-0-0' },
        { players: ['Spellstutter', 'BRV'], winner: 2, record: '2-0-0' },
        { players: ['Tanti', 'PolR'], winner: 1, record: '2-0-0' },
        { players: ['aspelled', 'Norbi'], winner: 1, record: '2-1-0' },
      ],
      [
        ...
        { players: ['Aleksandr_KoLoshk', 'aspelled'], winner: 2, record: '2-0-0' },
        { players: ['BRV', 'qvertion'], winner: 2, record: '2-0-0' },
        { players: ['Spellstutter', 'PolR'], winner: 1, record: '2-0-0' },
      ],
      [
        { players: ['4onoki', 'Azurenia'], winner: 1, record: '2-1-0' },
        { players: ['Tanti', 'qvertion'], winner: 2, record: '2-0-0' },
