...
export const _2026_specials: Tournament[] = [
  {
    ...
    date: '2026-03-16',
    standings: [
      { rank: 1, player: { display_name: 'grandpere_willy' }, deck: 'Orzhov Humans', points: 6 },
      { rank: 2, player: { display_name: 'kerdinand' }, deck: 'Mono-Blue Rona Combo', points: 6 },
      { rank: 3, player: { display_name: 'acc95' }, deck: 'Golgari Midrange', points: 6 },
      { rank: 4, player: { display_name: 'undeadmessenger' }, deck: 'Sultai Scapeshift', points: 6 },
      { rank: 5, player: { display_name: 'a5653' }, deck: 'Simic Merfolks', points: 6 },
      { rank: 6, player: { display_name: 'pinecone2100' }, deck: 'Azorius Control', points: 6 },
      { rank: 7, player: { display_name: '.revaen' }, deck: 'Golgari Sacrifice', points: 6 },
      { rank: 8, player: { display_name: 'blubet' }, deck: 'Simic Lotus Field', points: 3 },
      { rank: 9, player: { display_name: 'aireon' }, deck: 'Gruul Aggro', points: 3 },
      { rank: 10, player: { display_name: 'betabrett0223' }, deck: 'Grixis Aggro', points: 3 },
      { rank: 11, player: { display_name: 'shadymcshade' }, deck: 'Orzhov Doom', points: 3 },
      { rank: 12, player: { display_name: 'orbitacts' }, deck: 'Izzet Phoenix', points: 3 },
      { rank: 13, player: { display_name: 'nicklatkovich' }, deck: 'Azorius Control', points: 3 },
      { rank: 14, player: { display_name: 'xandyw' }, deck: 'Gruul Aggro', points: 3 },
      { rank: 15, player: { display_name: 'pillz235' }, deck: 'Temur Battlecrier', points: 3 },
      { rank: 16, player: { display_name: 'mentalmath' }, deck: 'Dimir Rogues', points: 3 },
      { rank: 17, player: { display_name: 'zaalo.38' }, deck: 'Dimir Rogues', points: 3 },
      { rank: 18, player: { display_name: 'flyingtoastr.' }, deck: 'Niv to Light', points: 3 },
      { rank: 19, player: { display_name: 'gnomeallusionist' }, deck: 'Boros Burn', points: 3 },
      { rank: 20, player: { display_name: 'calebk07' }, deck: 'Dimir Rogues', points: 3 },
      { rank: 21, player: { display_name: 'tiggy227' }, deck: 'Izzet Aggro', points: 3 },
      { rank: 22, player: { display_name: 'screamingseahawk5' }, deck: 'Azorius Merfolks', points: 3 },
      { rank: 23, player: { display_name: 'doctorskeltal' }, deck: 'Simic Scapeshift', points: 3 },
      { rank: 24, player: { display_name: 'numlkd' }, deck: 'Izzet Phoenix', points: 0 },
      { rank: 25, player: { display_name: 'smoliv121' }, deck: 'Azorius Control', points: 0 },
      { rank: 26, player: { display_name: 'dcroswell0028' }, deck: 'Orzhov Monument', points: 0 },
      { rank: 27, player: { display_name: 'canadianarmyman' }, deck: 'Mardu Cycling', points: 0 },
