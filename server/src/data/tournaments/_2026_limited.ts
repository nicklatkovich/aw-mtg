...
export const _2026_limited: Tournament[] = [
  {
    ...
    date: '2026-08-14',
    standings: [
      { player: 'BregoXX', rank: 1, points: 12, mp: 4, mw: 4, match_record: '4-0-0', game_record: '8-2-0' },
      { player: 'Odis89', rank: 2, points: 9, mp: 4, mw: 3, match_record: '3-1-0', game_record: '7-3-0' },
      { player: 'Bomj', rank: 3, points: 9, mp: 3, mw: 2, match_record: '3-1-0', game_record: '6-3-0' },
      { player: 'TroV1', rank: 4, points: 9, mp: 4, mw: 3, match_record: '3-1-0', game_record: '6-2-0' },
      { player: 'Replica_NT', rank: 5, points: 9, mp: 4, mw: 3, match_record: '3-1-0', game_record: '6-3-0' },
      { player: 'NikitaP', rank: 6, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '4-4-0' },
      { player: 'AntonH', rank: 7, points: 6, mp: 4, mw: 2, match_record: '2-2-0', game_record: '5-4-0' },
      { player: 'serj', rank: 8, points: 6, mp: 3, mw: 1, match_record: '2-2-0', game_record: '5-5-0' },
      { player: 'Danik1998', rank: 9, points: 6, mp: 3, mw: 1, match_record: '2-2-0', game_record: '6-5-0' },
      { player: 'AntonZubchenok', rank: 10, points: 4, mp: 4, mw: 1, match_record: '1-2-1', game_record: '4-5-1' },
      { player: 'Dalotus', rank: 11, points: 4, mp: 4, mw: 1, match_record: '1-2-1', game_record: '3-6-1' },
      { player: 'Spellstutter', rank: 12, points: 3, mp: 3, mw: 1, match_record: '1-2-0', game_record: '2-4-0' },
      { player: 'Vladosik', rank: 13, points: 3, mp: 2, mw: 0, match_record: '1-2-0', game_record: '2-4-0' },
      { player: 'KostkoK', rank: 14, points: 0, mp: 2, mw: 0, match_record: '0-2-0', game_record: '1-4-0' },
      { player: 'Roman_B', rank: 15, points: 0, mp: 2, mw: 0, match_record: '0-2-0', game_record: '1-4-0' },
    ],
    rounds: [
      [
        { players: ['Bomj', null], winner: 1, record: 'bye' },
        { players: ['AntonZubchenok', 'Replica_NT'], winner: 1, record: '2-0-0' },
        { players: ['TroV1', 'Odis89'], winner: 2, record: '2-0-0' },
        { players: ['KostkoK', 'BregoXX'], winner: 2, record: '2-1-0' },
        { players: ['Dalotus', 'Danik1998'], winner: 1, record: '2-1-0' },
        { players: ['AntonH', 'Roman_B'], winner: 1, record: '2-0-0' },
        { players: ['Vladosik', 'NikitaP'], winner: 2, record: '2-0-0' },
        { players: ['Spellstutter', 'serj'], winner: 1, record: '2-0-0' },
      ],
      [
        { players: ['serj', null], winner: 1, record: 'bye' },
        { players: ['NikitaP', 'BregoXX'], winner: 2, record: '2-0-0' },
        { players: ['Spellstutter', 'Odis89'], winner: 2, record: '2-0-0' },
        { players: ['Bomj', 'AntonZubchenok'], winner: 1, record: '2-1-0' },
        { players: ['AntonH', 'Dalotus'], winner: 1, record: '2-0-0' },
        { players: ['Vladosik', 'Replica_NT'], winner: 2, record: '2-0-0' },
        { players: ['Roman_B', 'Danik1998'], winner: 2, record: '2-1-0' },
        { players: ['TroV1', 'KostkoK'], winner: 1, record: '2-0-0' },
      ],
      [
        { players: ['Vladosik', null], winner: 1, record: 'bye' },
        { players: ['AntonH', 'Bomj'], winner: 2, record: '2-0-0' },
        { players: ['BregoXX', 'Odis89'], winner: 1, record: '2-1-0' },
        { players: ['AntonZubchenok', 'TroV1'], winner: 2, record: '2-0-0' },
        { players: ['Danik1998', 'serj'], winner: 2, record: '2-1-0' },
        { players: ['Spellstutter', 'Replica_NT'], winner: 2, record: '2-0-0' },
        { players: ['Dalotus', 'NikitaP'], winner: 2, record: '2-0-0' },
      ],
      [
        { players: ['Danik1998', null], winner: 1, record: 'bye' },
        { players: ['Bomj', 'BregoXX'], winner: 2, record: '2-0-0' },
        { players: ['Replica_NT', 'serj'], winner: 1, record: '2-1-0' },
        { players: ['AntonH', 'Odis89'], winner: 2, record: '2-1-0' },
        { players: ['NikitaP', 'TroV1'], winner: 2, record: '2-0-0' },
        { players: ['AntonZubchenok', 'Dalotus'], winner: 0, record: '1-1-1' },
      ],
    ],
  },
  {
